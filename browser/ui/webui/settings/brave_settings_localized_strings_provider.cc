...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"enhancedPhishingProtectionLabel",
       IDS_SETTINGS_ENHANCED_PHISHING_PROTECTION_LABEL},
      {"enhancedPhishingProtectionSubLabel",
       IDS_SETTINGS_ENHANCED_PHISHING_PROTECTION_SUB_LABEL},
      {"traceToolsMcpLabel", IDS_SETTINGS_TRACE_TOOLS_MCP_LABEL},
      {"traceToolsMcpSubLabel", IDS_SETTINGS_TRACE_TOOLS_MCP_SUB_LABEL},
      {"traceToolsMcpPortLabel", IDS_SETTINGS_TRACE_TOOLS_MCP_PORT_LABEL},
